      ...
      <div style={{ background: 'white', borderRadius: 28, padding: 40, width: 'min(440px, 100%)', boxShadow: '0 24px 80px rgba(0,0,0,0.12)' }}>
        ...
        {done ? (
          <div style={{ textAlign: 'center', paddingTop: 16 }}>
            ...
            <div style={{ fontWeight: 900, fontSize: 16, color: '#1A1A2E', marginBottom: 8 }}>Лозинката е променета!</div>
            <div style={{ fontSize: 14, color: '#888', fontWeight: 700, marginBottom: 24 }}>Можеш да се најавиш со новата лозинка.</div>
            <a href="/" style={{ background: '#FF6B4A', color: 'white', textDecoration: 'none', borderRadius: 50, padding: '14px 32px', fontSize: 15, fontWeight: 900 }}>
              Оди на почетна
            </a>
          </div>
        ) : !ready ? (
